...
| `htf_fair_value_gap_max_per_side`        | `3`          |
| `htf_fair_value_gap_min_atr_mult`        | `0.06`       |
| `htf_fair_value_gap_min_pct`             | `0.0006`     |
| `one_minute_fair_value_gaps_enabled`     | `true`       |
| `one_minute_fair_value_gap_max_per_side` | `3`          |
| `one_minute_fair_value_gap_min_atr_mult` | `0.06`       |
| `one_minute_fair_value_gap_min_pct`      | `0.0006`     |
